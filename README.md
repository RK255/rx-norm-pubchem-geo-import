...
# `src/rollback_import.ts` (Rollback Script)
A utility to undo the last import batch. It reads the operations generated by the import script, reverses them, and publishes the cleanup to your space.

bun run src/rollback_import.ts
